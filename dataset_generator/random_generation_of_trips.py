...
# --- EXECUTION ---
final_df = simulate_ridership('dataset_generator/stopwithZones.csv', "18/11/2021", 5, weather_file='dataset_generator/london_weather_hourly_estimated.csv')
